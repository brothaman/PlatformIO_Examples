...
def get_idestate(path):
    ...
    logger.debug("PRAGMA DEBUG: The path given was {}".format(path), exc_info=1)
    try:
        out = subprocess.check_output(cmd, universal_newlines=True)
        logger.debug("The output from the PIO command was {}".format(out))
...
if __name__ == "__main__":
    ...
    print('Information about all_flags:\n\tType: {}\n\tContents: {}'.format(type(all_flags),all_flags))
    for a in all_flags:
        print(a)
